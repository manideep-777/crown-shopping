...
export const emailSignInStart = withMatcher((credentials: { email: string, password: string }): EmailSignInStart =>
...
export const signUpStart = withMatcher((credentials: {email: string, password: string, displayName: string}): SignUpStart =>
    createAction(USER_ACTION_TYPES.SIGN_UP_START, credentials));

export const signUpSuccess = withMatcher((credentials: {user: User, additionalDetails: AdditionalInformation}): SignUpSuccess =>
